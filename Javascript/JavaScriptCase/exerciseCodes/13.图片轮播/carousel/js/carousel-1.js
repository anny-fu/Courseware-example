...
/* 全局变量、对象定义部分 */
/*************************************************/
var imgURL_list = ["img/01.jpg", "img/02.jpg", "img/03.jpg", "img/04.jpg", "img/05.jpg"];
 ...
 * 参数3：是否反相播放（Boolean。true：反相播放；false：正向播放，默认值）
 * 参数4：是否显示控制点(Boolean;true:显示，默认值，false：不显示)
 **/
function Imgcarousel(ident, timeInterval, reverse, pointShow) {
    // 图片轮播的主容器
    ...
    this.tabImageShow = function() {
            ...
            // （因为点击事件内的this不再指向当前构造函数被实例化后的对象）
